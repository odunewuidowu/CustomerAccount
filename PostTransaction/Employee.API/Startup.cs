...
namespace Employee.API
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "Post Transaction", Version = "v1" });
            });
           ...
           //services.AddMediatR(typeof(CreateTransHandler).GetTypeInfo().Assembly);
            ...
            services.AddTransient<ITransactionRepository, EmployeeRepository>();
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            if (env.IsDevelopment())
            {
                ...
                app.UseSwagger();
                app.UseSwaggerUI(c => c.SwaggerEndpoint("/swagger/v1/swagger.json", "Account Creation v1"));
            }
